...
def stock_price(sec,period,sday,eday):
  ...
  输出 个股的后复权的开高低收价格
  """
  temp= get_price(sec, start_date=sday, end_date=eday, frequency=period, fields=None, skip_paused=False, fq='pre', count=None).reset_index()\
