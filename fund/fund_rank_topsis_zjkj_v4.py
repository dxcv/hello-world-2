...
if __name__ == '__main__':
    ...
    today = str(today)[:10]
    fund_stime = str(datetime.datetime.today() - relativedelta(months=62))[:10]  # 基金池开始时间
    ...
    for i in underlying_asset_type_id:
        print(i)
        tmp = df_after_select[df_after_select['underlying_asset_type_id'] == i].copy()
    ...
    fund_rank_r.to_csv('result/fund_rank_by_topsis_v5.csv', encoding='gbk')
